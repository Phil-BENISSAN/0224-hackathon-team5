...
export default function Home() {
	return (
		<main>
			...
			<img
				className="bigImg"
				src="https://static.owayo-cdn.com/newhp/img/magazin/jeuxesportpopulaires/jeux-esport-populaires-monde-entier-670px.jpg"
				alt=""
			/>
		</main>
	);
	...
	// 								</li>
	// 								<li>
	// 									<Link to="/actus" className="footer-element">
	// 										Actualités
	// 									</Link>
	// 								</li>
	// 								<li>
	...
	// 								</li>
	// 								<li>
	// 									<Link to="/" className="footer-connexion">
	// 										Connexion
	// 									</Link>
	// 								</li>
	// 							</ul>
